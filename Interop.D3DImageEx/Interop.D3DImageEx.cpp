...
namespace System { namespace Windows { namespace Interop
{
	...
	/*
		This method is called only once, no matter how many instances of D3DImageEx have been created
	*/
	HRESULT D3DImageEx::InitD3D9(HWND hWnd)
	{
		...
		DWORD DeviceFlags = D3DCREATE_HARDWARE_VERTEXPROCESSING | D3DCREATE_MULTITHREADED | D3DCREATE_FPU_PRESERVE;
